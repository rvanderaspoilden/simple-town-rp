...
namespace Sim.Jobs {
    /// <summary>
    /// Une ligne de la todo-list des steps dans le JobActiveHUD : une case à cocher
    /// (cochée quand le step est complété) + le libellé du step. Le style change selon
    /// l'état : fait / en cours / à faire. Instanciée par <see cref="JobActiveHUD"/> à
    /// partir d'un template.
    /// </summary>
    public class JobStepRowUI : MonoBehaviour {
        [Header("Refs")]
