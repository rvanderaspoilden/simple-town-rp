...
public class ColorPaletteController : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler, IInitializePotentialDragHandler {
    ...
    [SerializeField]
    Image pickedColorImage;

    [SerializeField]
    Material colorWheelMat;

    [SerializeField]
    int totalNumberofColors = 24;
    ...
    [SerializeField]
    [Range(0.5f, 0.001f)]
    float minimumSatValStep = 0.01f;

    [SerializeField]
    [Range(0, 1)]
    float minimumSaturation = 0.25f;

    [SerializeField]
    [Range(0, 1)]
    float maximumSaturation = 1;

    [SerializeField]
    [Range(0, 1)]
    float minimumValue = 0.25f;
