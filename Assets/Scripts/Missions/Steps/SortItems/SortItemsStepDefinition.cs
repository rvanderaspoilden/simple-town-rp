...
namespace Sim.Missions {
    ...
    /// </summary>
    [CreateAssetMenu(menuName = "Sim/Missions/Steps/Sort Items", fileName = "SortItemsStep")]
    public class SortItemsStepDefinition : MissionStepDefinition {
        ...
        [Tooltip("Id d'un MissionSpawnSlots de la scène. Si renseigné, les colis sont posés sur ses " +
        ...
        [Tooltip("Si coché : répartit les colis sur des slots LIBRES DISTINCTS tirés au hasard " +
                 "parmi les slots non réservés (table d'attribution tenue par MissionSpawnSlots), " +
