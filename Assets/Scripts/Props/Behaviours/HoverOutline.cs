...
/// <summary>
/// Hover outline driver: moves the host's renderer GameObjects onto the "Outline"
...
///
/// Added/driven at runtime by CameraManager's hover raycast — no per-host setup.
/// Works for any hoverable target (props, NPCs, remote players, …). Requires a
/// layer named "Outline" (Project Settings ▸ Tags and Layers) + the
