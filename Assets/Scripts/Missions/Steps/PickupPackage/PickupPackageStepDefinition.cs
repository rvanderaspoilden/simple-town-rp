...
namespace Sim.Missions {
    ...
    /// il sera despawn au DeliverToTargetStep ou par MissionItemCleanup si la
    /// mission échoue/est abandonnée.
    /// </summary>
    [CreateAssetMenu(menuName = "Sim/Missions/Steps/Pickup Package", fileName = "PickupPackageStep")]
    public class PickupPackageStepDefinition : MissionStepDefinition {
        ...
        [SerializeField] private MissionTargetKey spawnAtKey = MissionTargetKey.Pickup;

        [Tooltip("Optionnel. Id d'un MissionSpawnSlots (ex. palette de livraison) : si renseigné " +
        ...
        [Tooltip("Index du slot à utiliser dans le MissionSpawnSlots ci-dessus (ignoré si Random Slot est coché).")]
        ...
        [Tooltip("Si coché : choisit automatiquement un slot LIBRE au hasard parmi les slots non " +
                 "réservés (table d'attribution tenue par MissionSpawnSlots). À utiliser quand tu " +
        ...
        public MissionTargetKey SpawnAtKey => spawnAtKey;
