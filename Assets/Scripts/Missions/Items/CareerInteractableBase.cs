...
namespace Sim.Missions {
    ...
    public abstract class CareerInteractableBase : MonoBehaviour, IInteractable {
        [Header("Career gate")]
        [Tooltip("Profession (ProfessionConfig) the player must be employed in to use this object.")]
        [SerializeField] protected ProfessionConfig requiredProfession;
        ...
        public ProfessionConfig RequiredProfession => requiredProfession;
        public string RequiredProfessionId => requiredProfession != null ? requiredProfession.id : "";
        ...
        protected virtual void Start() {
            if (HighlightKind != MissionHighlightKind.None) {
                ...
                MissionHighlightManager.Register(HighlightKind, GetHighlightId(), _highlightEffect, RequiredProfessionId, HighlightPhase);
            }
        }
